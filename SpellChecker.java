 ...
 * 
 * @author CS 2420 course staff and Cameron McKay and Daler Turyssov
...
public class SpellChecker {
	...
	/**
	 * Spell-checks a document against the dictionary. Makes a list of words from
	 * the document that are not in the dictionary.
	 * 
